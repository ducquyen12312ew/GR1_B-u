...
let postBookAppointment = (data) => {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      console.log("User created/found:", user[0].id);
      ...
      if (user && user[0]) {
        ...
        const emailData = {
          ...
          appointmentTime: timeTypeData ? timeTypeData.valueVi : data.timeType,
        ...
        try {
          ...
          resolve({
            ...
            emailMessage: emailResult.message || "Email confirmation processed",
          });
        } catch (emailError) {
